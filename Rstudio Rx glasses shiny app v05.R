  ...
  sidebarLayout(
    sidebarPanel(
      ...
      numericInput(inputId = "TL", 
                   label = tags$h5("Temple length (Frame size ##-##-???)"), 
                   value = 147),
      tags$hr(),
    ...
    mainPanel(
      ...
      tags$h3("If your lenses are too thick, try higher index lenses or choosing frames with smaller lenses."),
      tags$h5('1.50 - Standard Index(+$0)'),
      tags$h5('1.61 - High Index (+$80)'),
      tags$h5('1.67 - High Index (+$100)'),
      tags$h5('1.74 - High Index (+$150)')
    )
  )  
)
